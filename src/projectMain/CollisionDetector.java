    ...
    public void checkTile(Entity entity) {
        ...
        switch (entity.direction) {
            case "up":
                ...
                tileNum = gamePanel.tileManager.mapTileNum[entityLeftCol][entityTopRow];
                tileNum2 = gamePanel.tileManager.mapTileNum[entityRightCol][entityTopRow];
                if ((gamePanel.tileManager.tile[tileNum].collision || gamePanel.tileManager.tile[tileNum2].collision)) {
            ...
            case "down":
                ...
                tileNum = gamePanel.tileManager.mapTileNum[entityLeftCol][entityBottomRow];
            ...
            case "right":
                ...
                tileNum = gamePanel.tileManager.mapTileNum[entityRightCol][entityTopRow];
                tileNum2 = gamePanel.tileManager.mapTileNum[entityRightCol][entityBottomRow];
                if ((gamePanel.tileManager.tile[tileNum].collision || gamePanel.tileManager.tile[tileNum2].collision)) {
                    entity.collisionOn = true;
                }
